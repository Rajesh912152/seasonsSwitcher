...
function changeSeasonToSpring() {
    ...
    seasonMediumImageElement = springMediumImage;

}

function changeSeasonToSummer() {
    seasonSmallImageElement = summerSmallImage;
    seasonMediumImageElement = summerMediumImage;

}

function changeSeasonToAutumn() {
    seasonSmallImageElement = autumnSmallImage;
    seasonMediumImageElement = autumnMediumImage;

}

function changeSeasonToWinter() {
    seasonSmallImageElement = winterSmallImage;
    seasonMediumImageElement = winterMediumImage;
}